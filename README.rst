...
all necessary requirements as follows::
  ...
  (vivarium_conic_vitamin_a_supp) :~$ git clone https://github.com/ihmeuw/vivarium_conic_vitamin_a_supp.git
...
install hdf tooling from within your environment like so::
  ...
  (vivarium_conic_vitamin_a_supp) :~$ conda install hdf5

The ``(vivarium_conic_vitamin_a_supp)`` that precedes your shell prompt will probably show
...
from any directory.::
  ...
  (vivarium_conic_vitamin_a_supp) :~$ make_specs -v
  2020-06-18 18:18:28.311 | 0:00:00.679701 | build_model_specifications:48 - Writing model spec(s) to "/REPO_INSTALLATION_DIRECTORY/vivarium_conic_vitamin_a_supp/src/vivarium_conic_vitamin_a_supp/model_specifications"
...
run simulations by, e.g.::
   ...
   (vivarium_conic_vitamin_a_supp) :~$ simulate run -v /<REPO_INSTALLATION_DIRECTORY>/vivarium_conic_vitamin_a_supp/src/vivarium_conic_vitamin_a_supp/model_specifications/china.yaml
